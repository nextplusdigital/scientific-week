 ...
 * @type {string}
 */
export const label = 'Tipo de Animal'

/**
 * @type {string}
 */
export const title = 'Cadastro de Tipo de Animal'

/**
 * @type {string}
 */
export const tooltip = 'Gerencie o organize o seu cadastro de Tipo de Animal'

/**
 * @type {string}
 */
export const description = 'Tipo de Animal utilizados para vacinação'

/**
 * @type {string}
 */
export const api = '/api/tipo-animals'
 ...
 * @type {string}
 */
export const path = '/dashboard/admin/tipo-animals'

/**
 * @type {string}
 */
export const namespace = 'admin.tipo-animals'
 ...
 * @type {Function}
 */
export const menu = model.menu(icon, label, path, false, tooltip, 'admin.tipo-animals', namespace, 1)
